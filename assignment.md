...
You can download the sample data at [./data/pymbox-short.txt](https://github.com/alexseong/dsy_python_intro_3/tree/master/data/pymbox-short.txt) when you are testing below enter mbox-short.txt as the file name.
